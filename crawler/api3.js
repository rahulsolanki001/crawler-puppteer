    ...
    //  })   */ 
      ...
      await cluster.task(async ({page,data:{url,product,location}})=>{
          ...
          if(url===BASE_URL){
            ...
            console.log("page open in blink");
...
// console.log(`BlinkIt Time taken: ${elapsed} ms`);
      ...
      await page.evaluate(() => {
          document.body.style.zoom = "30%";
              ...
              await page.keyboard.type(location, { delay: 200 }); //enterusername
          ...
          //    await page.waitForNetworkIdle({ waitUntil: 'networkidle2' });
             ...
             console.log('====================================');
             console.log("click on type location");
             console.log('====================================');
...
// await delay(1000)
              ...
              console.log('====================================');
              console.log("wait selector to click");
              console.log('====================================');
              await page.$eval(
                 "#expandable-view > div > div.sc-AxjAm.StDqM.sc-4bil4e-1.cKnqnJ > div > div > div.sc-AxjAm.StDqM.sc-AxirZ.ktnnZL.sc-1w2vjuw-1.gnVSnQ > div.sc-AxjAm.StDqM.sc-5mb6ac-0.gFfvoJ > div:nth-child(2) > div",
                  (form) => form.click()
             );
          ...
          //    await delay(600000);
             ...
             console.log('====================================');
             console.log("after selector to click");
             console.log('====================================');
...
console.log('====================================');
console.log("click to search product");
console.log('====================================');
             console.log('====================================');
             console.log("click to open searchproduct");
             console.log('====================================');
              //  await delay(500);// not in use
//                  await page.waitForNavigation({ waitUntil: ["domcontentloaded","load","networkidle0","networkidle2"] });

// await page.waitForSelector('#__next > div:nth-child(2) > div.sc-AxjAm.StDqM.sc-1igvtxh-1.dkYYRT > div > div.sc-fzqBZW.cdLHjT.sc-fzqPZZ.kDXrhw.sc-nukjgu-1.azWIq > input')

// await page.$eval("#__next > div:nth-child(2) > div.sc-AxjAm.StDqM.sc-1igvtxh-1.dkYYRT > div > div.sc-fzqBZW.cdLHjT.sc-fzqPZZ.kDXrhw.sc-nukjgu-1.azWIq > input",(form)=>form.focus()
// );
...
// await delay(1000);
              ...
              console.log('====================================');
              console.log("list of product after enter",product);
              console.log('====================================');
...
// // Calculate the elapsed time
// const elapsed = endTime - startTime;
// console.log(`Dunzo Time taken: ${elapsed} ms`);
...
// // Calculate the elapsed time
// const elapsed = endTime - startTime;
// console.log(`Instamart Time taken: ${elapsed} ms`);
          }
...
app.get('/instamart',async(req,res)=>{
    ...
    const data=await getData(req.query.product,req.query.location,"instamart");
...
app.listen(5000,()=>{
    console.log("app listening on post 7000" );
})
